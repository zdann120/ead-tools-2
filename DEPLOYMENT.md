# How to deploy EuroAmericaTools
...
sudo service unicorn_EuroAmericaTools <start|stop|restart>
sudo service sidekiq_EuroAmericaTools <start|stop>
```
...
```
/home/deployer/apps/EuroAmericaTools/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_EuroAmericaTools restart
sudo service sidekiq_EuroAmericaTools stop
sudo service sidekiq_EuroAmericaTools start
```
